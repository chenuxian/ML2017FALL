import sys, re, jieba, numpy, gensim, csv
...
if sys.argv[1] == "train":
    ...
    model = word2vec.Word2Vec(sentences, size = 300, window = 50, min_count = 12, iter = 30, hs = 1, sample = 1e-5)
...
if sys.argv[1] == "test":
    ...
    with open("output.csv", 'w', encoding='utf-8') as wf:
        ...
        with open('testing_data.csv','r') as rf:
